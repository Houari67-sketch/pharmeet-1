...
export default function PharmacienScreen() {
  const router = useRouter();

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Espace Pharmacien</Text>
      <Text style={styles.subtitle}>Missions, disponibilité, candidatures</Text>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>Infos nécessaires</Text>
        <Text style={styles.cardText}>• Nom / Prénom</Text>
        <Text style={styles.cardText}>• Statut (titulaire, adjoint, remplaçant…)</Text>
        <Text style={styles.cardText}>• N° RPPS / ADELI (plus tard)</Text>
        <Text style={styles.cardText}>• Ville + rayon (km)</Text>
        <Text style={styles.cardText}>• Disponibilités</Text>
        <Text style={styles.cardText}>• Expérience / compétences (optionnel)</Text>
      </View>
      ...
      <Pressable style={[styles.btn, styles.logout]} onPress={() => router.replace("/login" as any)}>
